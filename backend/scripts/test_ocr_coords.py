...
#   옮겼다 (2026-07-27). 문자 단위 정규식은 '매매'+'홍길동'을 한 덩어리로 삼켜 bbox가
...
def check_owner(pages: list[Page]) -> None:
    ...
    print("     추출 방식: 등록번호 word(`900101-*******`)를 먼저 찾고 **바로 앞 word**를 이름으로 삼는다.")
    print("     (문자 단위 정규식은 '매매'+'홍길동'을 한 덩어리로 삼켜 bbox가 옆 칸까지 번졌다)")
    ...
    print("  기대치: 갑구에 개인 5명(홍길동·이철수·박영수·홍길동·김영희),")
