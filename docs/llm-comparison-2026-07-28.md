...
- 입력 OCR: ocr_page_1.json, ocr_page_2.json, ocr_page_3.json, ocr_page_4.json, ocr_page_5.json (4,842자 레이아웃 텍스트)
- 구조화 정답지(대조용): `ie_20260728_004828_891.json` — Upstage Information Extract 결과
...
|---|---|---|---|---|---|
| `upstage` | 3/3 | 9.1 | 83% | 66% | 흔들림(3종) |
| `exaone` | 3/3 | 21.3 | 50% | 65% | 흔들림(3종) |

### 필드별 항목 수 (IE vs 각 provider, 1회차 기준)

| 필드 | IE | upstage | exaone |
|---|---|---|---|
| `current_owners` | 1 | 1 | 1 |
| `mortgages` | 3 | 5 | 4 |
| `jeonse_rights` | 0 | 0 | 0 |
| `lease_registrations` | 0 | 0 | 0 |
| `provisional_seizures` | 1 | 3 | 3 |
| `seizures` | 1 | 2 | 2 |
| `auction_commencements` | 1 | 2 | 2 |
...
|---|---|---|---|---|---|---|
| `upstage` | 3/3 | 2.5 | 3/3 | 0건 | 0건 | 흔들림(3종) |
| `exaone` | 3/3 | 4.2 | 3/3 | 0건 | 0건 | 흔들림(3종) |
